...
export default function Home() {
  return (
    <>
      <Head>
        <title>Domů | iPhone 13 Pro</title>
      </Head>
      <Header />
      <main>
        <section className="max-w-screen-sm mx-auto px-8 text-center py-16">
        ...
        <section className="max-w-screen-xl mx-auto px-8 py-8 sm:grid grid-cols-2 gap-16 items-center">
